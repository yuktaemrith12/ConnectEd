...
import {
  studentGetWhatsAppSettings,
  studentUpdateWhatsAppSettings,
  studentDisconnectWhatsApp,
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-gray-600 mb-4">
          Enter your WhatsApp number in international format. ConnectEd will send you
          school updates directly to this number.
        </p>
        ...
        <button
          ...
          disabled={saving}
          className="w-full py-3 rounded-2xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-sm font-semibold hover:shadow-lg hover:shadow-blue-200 transition-all flex items-center justify-center gap-2 disabled:opacity-60"
        >
          {saving ? (
            <>
...
export default function WhatsAppNotifications() {
  ...
  const handleToggle = async (field: keyof WhatsAppSettings, value: boolean) => {
    ...
    try {
      const updated = await studentUpdateWhatsAppSettings({ [field]: value });
      setSettings(updated);
    } catch {
  ...
  const handleConnect = async (phone: string) => {
    setSaving(true);
    try {
      const updated = await studentUpdateWhatsAppSettings({ phone_number: phone });
      setSettings(updated);
      setShowModal(false);
  ...
  const handleDisconnect = async () => {
    setSaving(true);
    try {
      await studentDisconnectWhatsApp();
  ...
  return (
    <DashboardLayout role="student">
      <div className="min-h-screen bg-gradient-to-br from-blue-50/60 via-white to-indigo-50/40 p-6">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Receive your school updates directly on WhatsApp</p>
            </div>
          </motion.div>
          ...
          {loading ? (
            ...
            <>
                ...
                <div className="flex items-center justify-between relative z-10">
                  <div className="flex items-center gap-4">
                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center
                      ${isConnected ? "bg-white/20" : "bg-blue-50"}`}
                    >
                      {isConnected ? (
                        <motion.div
                  ...
                  {isConnected ? (
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-sm font-semibold shadow-md shadow-blue-200 hover:shadow-lg hover:shadow-blue-300 transition-all"
                    >
              ...
              >
                ...
                <div className="space-y-2">
                  <PrefRow
                    ...
                    label="Events & Exams"
                    description="School events, exams, and announcements"
                  ...
                  <PrefRow
                    ...
                    label="Attendance"
                    description="Alerts when you are marked absent or late"
                  ...
                  <PrefRow
                    ...
                    description="Notified when your assignment grades are published"
                  ...
                  <PrefRow
                    ...
                    description="When a teacher posts a new assignment for your class"
              ...
              <motion.div
                ...
                className="flex items-start gap-2.5 p-4 rounded-2xl bg-blue-50 border border-blue-100"
              >
                <MessageCircle className="w-4 h-4 text-blue-500 mt-0.5 flex-shrink-0" />
                <p className="text-xs text-blue-700 leading-relaxed">
                  These settings apply to your student account. You will receive alerts
                  directly about <strong>your own</strong> grades, attendance, and deadlines.
                </p>
              </motion.div>
            </>
          )}
