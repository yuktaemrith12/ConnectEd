...
import { StudentAttendanceSummary, StudentSessionRecord, getStudentAttendanceSummary } from "@/app/utils/api";
...
export default function StudentAttendance() {
  ...
  const stats = summary ? [
    { label: "Overall Attendance", value: `${summary.attendance_rate}%`, icon: BarChart3, color: "from-blue-500 to-blue-400" },
    { label: "Total Sessions",     value: summary.total_sessions,        icon: Calendar,  color: "from-indigo-500 to-indigo-400" },
    { label: "Present",            value: summary.present_count,         icon: CheckCircle, color: "from-green-500 to-green-400" },
    ...
    <DashboardLayout role="student">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Your session-by-session attendance record</p>
        </div>
        ...
        {summary && (
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            <div className="flex justify-between items-center mb-2">
              ...
              <p className="text-blue-600 font-bold">{summary.attendance_rate}%</p>
            </div>
                  ...
                  <tr key={idx} className={`border-t border-gray-50 ${idx % 2 ? "bg-gray-50/30" : ""}`}>
                    ...
                    <td className="px-5 py-3">
                      <span className={`px-2 py-0.5 rounded text-xs font-medium ${
                        rec.delivery_mode === "ONLINE" ? "bg-purple-100 text-purple-700" : "bg-gray-100 text-gray-600"
                      }`}>
                        {rec.delivery_mode}
                      </span>
                    </td>
