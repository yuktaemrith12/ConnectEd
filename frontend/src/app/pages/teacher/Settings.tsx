...
export default function TeacherSettings() {
  ...
  const handlePasswordChange = async () => {
    ...
    setSaving(true);
    try {
      const res = await teacherChangePassword(currentPassword, newPassword);
        ...
        >
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all pr-12"
                />
                <button
            ...
            <motion.button
              ...
              disabled={saving}
              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-shadow disabled:opacity-50"
            >
              <Save size={18} />
