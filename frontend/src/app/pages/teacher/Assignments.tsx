                          ...
                          {gradingSub.ai_reviewed && gradingSub.ai_reviews.length > 0 && (
                            <div className="mb-4 p-3 bg-purple-50 border border-purple-200 rounded-xl">
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                <span className={`text-xs px-2 py-0.5 rounded-full ${gradingSub.ai_reviews[gradingSub.ai_reviews.length - 1].confidence_score === "high"
                ...
                <form onSubmit={handleCreate} className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {(["ONLINE", "ON_SITE"] as const).map(t => (
                      <button
                        ...
                        className={`flex items-center gap-3 p-3 rounded-xl border-2 transition-colors ${form.type === t ? "border-purple-500 bg-purple-50" : "border-gray-200 hover:border-gray-300"
                          }`}
                      >
                        {t === "ONLINE"
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-3 py-2 border rounded-lg text-sm transition-colors ${answerSheet
